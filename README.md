...
#### $field-&gt;toChoices($all, $context) 

- **all:**  *bool*   
     Whether to include all defined choices or not. Defaults to `false`.
- **context:**  *string*   
...
Choices extends the default Kirby Collection class and thus offers all methods known from other Kirby object like `first()`, `last()`, `shuffle()`, `sort()` and the like.
